...
/* Formatar preço para o padrão BR */
document.getElementById('input-preco').addEventListener('input', function(e) {
...
/* Validar campo permitindo que digite apenas números */
document.getElementById('input-quantidade').addEventListener('input', function(e) {
    let valor = e.target.value;
